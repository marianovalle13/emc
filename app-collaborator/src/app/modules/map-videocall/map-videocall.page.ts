...
@Component({
  selector: 'app-map-videocall',
  templateUrl: './map-videocall.page.html',
  styleUrls: ['./map-videocall.page.scss'],
})
export class MapVideocallPage implements OnInit {
  ...
  loadMap() {
    ...
    this.map = new google.maps.Map(document.getElementById('mapvideo'), {
  ...
  goToService() {
    this.router.navigate(["/finish-service"])
  }
