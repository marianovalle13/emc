...
module.exports = (module) => {
   ...
   * @return {void}
   */
  module.router.get('/', global.helpers.security.auth(['user', 'administrator']), (req, res, next) => {
   ...
   * @return {void}
   */
  module.router.get('/:id', global.helpers.security.auth(['user', 'administrator']), (req, res, next) => {
   ...
   * @return {void}
   */
  module.router.post('/', global.helpers.security.auth(['user']), (req, res, next) => {
   ...
   * @return {void}
   */
  module.router.delete('/:id', global.helpers.security.auth(['user', 'administrator']), (req, res, next) => {
